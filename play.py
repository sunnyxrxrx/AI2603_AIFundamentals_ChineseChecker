...
# Policies
from agents import *
from mytrain import MyPPOPolicy
...
def play(args):
    ...
    if not args.use_rl:
        ...
        your_policy = MyPPOPolicy(args.checkpoint, env, triangle_size=args.triangle_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--triangle_size', type=int, default=4)  # 三角区域大小
